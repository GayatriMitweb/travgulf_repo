...
if($exc_id != ''){
    $query = mysql_fetch_assoc(mysql_query("select * from excursion_master where exc_id='$exc_id'"));
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Excursion Report')
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, "Exc_DateTime")
        ->setCellValue('F'.$row_count, "City Name")
        ->setCellValue('G'.$row_count, "Exc Name")
...
header('Content-Disposition: attachment;filename="ExcursionReport('.date('d-m-Y H:i:s').').xls"');
