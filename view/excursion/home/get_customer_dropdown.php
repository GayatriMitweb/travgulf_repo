...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="exc_id_dropdown_load('customer_id_filter','exc_id_filter')" class="form-control" title="Customer" style="width:100%">
