...
<div id="div_quotation_list_reflect" class="main_block loader_parent">
	<div class="row mg_tp_20"> <div class="col-md-12 no-pad"> <div class="table-responsive">
		<table id="quotation_reply" class="table table-hover" style="margin: 20px 0 !important;">         
		</table>
	</div></div></div>
</div>
...
<script>
$('#quotation_for_filter,#enquiry_id').select2();
...
function list_reflect()
{
  $('#div_list_reflect').append('<div class="loader"></div>');
	...
	$.post('reply/list_reflect.php', { quotation_for : quotation_for, enquiry_id : enquiry_id,  branch_status : branch_status }, function(data){
		pagination_load(data, column, true, false, 20, 'quotation_reply');
		$('.loader').remove();
	});
}
list_reflect();
function view_modal(id)
{
	...
	$.post('reply/cost_view/index.php', { id : id }, function(data){
