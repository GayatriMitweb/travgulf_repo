...
?>
<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	<select name="vendor_id" id="vendor_id" title="Select Excursion Supplier" style="width:100%" onchange="payment_for_single_purch(this.id,'<?= $vendor_type ?>','div_payment_for');">
		<?php 
		if($vendor_type_id==""){
			?>
