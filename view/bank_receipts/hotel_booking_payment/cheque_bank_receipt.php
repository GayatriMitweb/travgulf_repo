...
$sq_payment = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from hotel_booking_payment where payment_id in ('$payment_id_arr1')"));
...
{
	$sq = mysql_query("select * from hotel_booking_payment where payment_id='$payment_id_arr[$i]'");
