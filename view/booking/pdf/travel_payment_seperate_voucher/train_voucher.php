...
$pdf->Cell(190,10,'Railway Booking',1,1,'C');
...
$pdf->SetXY(120,$y_pos);
$pdf->Cell(53,7,'Booking ID :'.get_group_booking_id($tourwise_details['id']),1,1,'L');

$y_pos = $pdf->getY();
$pdf->SetXY(120,$y_pos);
$pdf->Cell(53,7,'Date :'.date('d-m-Y'),1,1,'L');
...
$y_pos = $pdf->getY()+2;
$pdf->SetXY(10,$y_pos);
$pdf->Cell(45,7,'Class :',0,1,'L');
$pdf->Line(24, $y_pos+5, 98, $y_pos+5);

$y_pos = $pdf->getY()+2;
$pdf->SetXY(10,$y_pos);
$pdf->Cell(45,7,'Train No :',0,1,'L');
$pdf->Line(29, $y_pos+5, 98, $y_pos+5);

$pdf->SetXY(100,$y_pos);
$pdf->Cell(45,7,'Train Name :',0,1,'L');
$pdf->Line(125, $y_pos+5, 200, $y_pos+5);
...
$sq_members = mysql_query("select * from travelers_details where traveler_group_id='$traveler_group_id' and status='Active'"); 
$count = 0;
