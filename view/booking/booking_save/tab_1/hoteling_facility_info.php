...
<div class="row text-center mg_bt_20">
    ...
    <div class="col-md-2 col-sm-6 col-xs-12 mg_bt_10_xs">
        ...
        <input type="text" id="txt_stay_total_seats" value="0" name="txt_stay_total_seats" title="Total Passenger" readonly />
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
        ...
        <select id="txt_double_bed_room" title="Double Bed Room" onchange="payment_details_reflected_data('tbl_member_dynamic_row')" name="txt_double_bed_room">
            <?php 
            for($i=0; $i<=20; $i++){
                echo '<option value="'.$i.'">'.$i.'</option>';
            }
