  ...
  <!--=======Header panel end======-->
    ...
    <div class="app_panel_content no-pad"> 
        ...
        <div class="container">
            ...
            <div class="panel panel-default panel-body main_block pad_8 text-center">
                <div class="row">
                    <div class="col-md-5 col-sm-6 col-xs-12 text-right text_center_xs"><label>Total Travel Expense</label></div>
                    <div class="col-md-2 col-sm-4 col-xs-12"><input type="text" id="txt_travel_total_expense" name="txt_travel_total_expense" value="0" class="text-right amount_feild_highlight" title="Total Travel Expense" readonly /></div>
                </div>
            </div>
        </div>
