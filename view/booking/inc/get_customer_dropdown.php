...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="customer_booking_dropdown_load(this.value)" class="form-control" title="Customer" style="width:100%">
