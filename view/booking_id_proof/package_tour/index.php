         ...
         <select id="cmb_traveler_id" name="cmb_traveler_id" title="Passenger Name" style="width:100%" onchange="traveler_id_proof_info_reflect()" title="Passenger"> 
              ...
              <?php 
                  ...
                  while($row_booking = mysql_fetch_assoc($sq_booking))
                  {
                    ...
                    $year =$yr[0];
                      $sq_traveler = mysql_query("select traveler_id, m_honorific, first_name, last_name from package_travelers_details where booking_id='$row_booking[booking_id]' and status!='Cancel'");
