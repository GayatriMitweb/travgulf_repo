...
$query = "select * from customer_master where customer_id = '$customer_id'";
?>
      ...
      <div class="modal-body profile_box_padding">
      	...
      	<div>
			  ...
			  <ul class="nav nav-tabs" role="tablist">
			    <li role="presentation" class="active"><a href="#basic_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Customer Information</a></li>
