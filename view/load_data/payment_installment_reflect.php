...
<?php
  ...
  if($role=="Booker")
  {
    $query = "select id, traveler_group_id from tourwise_traveler_details where tour_id = '$tour_id' and tour_group_id = '$tour_group_id' and booker_id = '$booker_id' and tour_group_status != 'Cancel' ";
  }
  if($role=="Admin")
  {
  ...
  echo "<option value=''> Select Traveler Group </option>";
