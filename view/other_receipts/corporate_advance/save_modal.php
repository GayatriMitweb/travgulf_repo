            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <select id="cust_id" name="cust_id" class="form-control" style="width:100%" title="Customer">
                  <?php get_corpo_customer_dropdown($role,$branch_admin_id,$branch_status); ?>
                </select>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
      ...
      if(data !== 'valid'){
        ...
        return false;
          ...
          $.ajax({
            ...
            data: { cust_id : cust_id, payment_amount : payment_amount, payment_date : payment_date, payment_mode : payment_mode, bank_name : bank_name, transaction_id : transaction_id, bank_id : bank_id, particular : particular, branch_admin_id : branch_admin_id },
