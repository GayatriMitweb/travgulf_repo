...
?>
	<div class="col-md-6 col-sm-12 col-xs-12">
		<div class="widget_parent-bg-img bg-img-red">
			<?php
	            begin_widget();
				$title_arr = array("Basic_Cost", "Service_Charge","&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tax","Markup","Markup_Tax","Roundoff", "Net_Total");
				$content_arr = array( $sq_booking['basic_cost'], "&nbsp;".$sq_booking['service_charge'], $service_tax_amount,$sq_booking['markup'],$markupservice_tax_amount,$sq_booking['roundoff'],$sq_booking['net_total']);
...
<form id="frm_refund" class="mg_bt_150">
	...
	<div class="row text-center">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancellation Charges" title="Cancellation Charges" onchange="calculate_total_refund();validate_balance(this.id);" value="<?= $sq_booking['cancel_amount'] ?>">
		</div>
...
function calculate_total_refund()
{
	...
	if(parseFloat(cancel_amount) > parseFloat(total_sale)) { error_msg_alert("Cancellation Charges can not be greater than Sale amount"); }
