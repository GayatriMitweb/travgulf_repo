...
while($row_payment = mysql_fetch_assoc($sq_payment)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('C'.$row_count, get_bus_booking_id($row_payment['booking_id'],$year))
...
header('Content-Disposition: attachment;filename="Bus Payment('.date('d-m-Y H:i:s').').xls"');
