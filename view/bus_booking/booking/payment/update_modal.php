...
$sq_booking = mysql_fetch_assoc(mysql_query("select * from bus_booking_master where booking_id='$sq_payment_info[booking_id]'"));
         ...
         <div class="row mg_bt_10">
          ...
          <div class="col-md-3">
            <select name="booking_id" id="booking_id" style="width:100%" disabled>              
              ...
              <?php
              $sq_booking = mysql_query("select * from bus_booking_master where customer_id='$sq_booking[customer_id]'");
