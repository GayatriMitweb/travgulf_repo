...
if($travel_type=='Local'){
    $sq = mysql_query("select * from car_rental_tariff_entries where vehicle_name='$vehicle_name' and tour_type = '$travel_type' and status!='Inactive'");
}else{
    $sq = mysql_query("select * from car_rental_tariff_entries where vehicle_name='$vehicle_name' and tour_type = '$travel_type' and route = '$places_to_visit' and status!='Inactive'");
}
