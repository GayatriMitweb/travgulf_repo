...
<?php
  ...
  $sq = mysql_query("select id, traveler_group_id from tourwise_traveler_details where tour_id = '$tour_id' and tour_group_id = '$tour_group_id' ");
  ...
  {
  	$sq = mysql_query("select * from travelers_details where traveler_group_id = '$traveler_group_id_arr[$i]'");
  	while($row = mysql_fetch_assoc($sq))
  	{
