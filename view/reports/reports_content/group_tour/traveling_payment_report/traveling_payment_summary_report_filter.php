...
<table class="table trable-hover" id="payment_c">
<thead>
...
if($traveler_group!="")
{
	$query = $query." traveler_group_id = '$traveler_group' ";
}	
else
{
	$query = $query." 1 ";
...
<tfoot>
	<tr class="active">
		<th colspan="9" class="text-right">Pending Refund : <?= $pending_refund;?></th>

		<th colspan="5" class="text-right">Available Balance : <?= $avalable_bal?></th>
	</tr>
</tfoot>
</table>
</div>	</div> </div>
