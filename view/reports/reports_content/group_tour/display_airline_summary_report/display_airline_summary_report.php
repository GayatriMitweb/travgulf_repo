			...
			<table class="table trable-hover table-bordered no-marg" id="supplier_info2">
				...
				<tr class="table-heading-row">
					...
					<tbody>
						...
						$sq_query = mysql_query("select * from vendor_estimate where vendor_type_id='$supplier_id' and vendor_type='Ticket Vendor' ");
	...
	<div class="col-md-6">
		...
		<div class="table-responsive">
			...
			<tbody>
				...
				$total_amount=0;    	            
				$count = 0;
			  	$sq_supp = mysql_query("select * from flight_supplier_payment where supplier_id='$supplier_id' and payment_amount !='0' and (clearance_status!='Pending' and clearance_status!='Cancelled')");  
