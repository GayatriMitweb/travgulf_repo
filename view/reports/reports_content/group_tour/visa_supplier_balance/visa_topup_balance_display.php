...
<div id="app_report_content_parrent">
  <table class="table table-bordered no-marg" id="tbl_supplier_list">
        ...
        <tr>
                    ...
                    <td>
                      <label class="tbl_radio_btn_body">
                        <input type="radio" id="report_name_rd_c" name="report_name_rd_c" onclick="display_visa_summary(<?php echo $row_query['vendor_id']; ?>);">
...
function display_visa_summary(supplier_id)
{
  $.get( "reports_content/group_tour/visa_supplier_balance/display_visa_balance_summary.php" , { supplier_id : supplier_id } , function ( data ) {
