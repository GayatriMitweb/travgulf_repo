...
<tfoot>
	<tr class="active">
		...
		<th>Total Paid : <?= $total=$sq_paid_amount+$sq_pending_amount+$sq_cancel_amount; ?></th>
		<th>-</th>

		<th>Total Pending : <?= $sq_pending_amount?></th>
		<th>-</th>

		<th>Total Cancel : <?= $sq_cancel_amount?></th>
		<th>=</th>
		<th>Total Payment : <?= $Total_payment=$total-$sq_pending_amount-$sq_cancel_amount; ?></th>
	</tr>
</tfoot>	
</table>
</div>	</div> </div>
