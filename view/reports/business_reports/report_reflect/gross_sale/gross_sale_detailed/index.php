...
<form id="frm_save">
    ...
    <div class="row mg_tp_20"> <div class="col-md-12 no-pad"> <div class="table-responsive">
        ...
        $sq_group = mysql_fetch_assoc(mysql_query("select sum(total_tour_fee) as total_tour_fee, sum(total_travel_expense) as total_travel_expense from tourwise_traveler_details where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
        $sq_group_pre = mysql_fetch_assoc(mysql_query("select sum(total_tour_fee) as total_tour_fee, sum(total_travel_expense) as total_travel_expense from tourwise_traveler_details where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
        ...
        AND YEAR(form_date) = YEAR(form_date) AND financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
        ...
        FROM  tourwise_traveler_details WHERE MONTH(form_date) = MONTH(form_date)
        AND YEAR(form_date) = YEAR(form_date) AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
       ...
       $pckg_ledger_arr = array();
        ...
        while($row=mysql_fetch_assoc($sql_package)){
            $customer_id = $row['customer_id'];
            $ledger_name = mysql_fetch_assoc(mysql_query("select * from ledger_master where customer_id='$customer_id' and user_type='customer'"));
        $sq_package = mysql_fetch_assoc(mysql_query("select sum(actual_tour_expense) as actual_tour_expense, sum(total_travel_expense) as total_travel_expense from package_tour_booking_master where financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
        $sq_package_pre = mysql_fetch_assoc(mysql_query("select sum(actual_tour_expense) as actual_tour_expense, sum(total_travel_expense) as total_travel_expense from package_tour_booking_master where financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
        ...
        AND YEAR(booking_date) = YEAR(booking_date) AND financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
        ...
        FROM package_tour_booking_master WHERE MONTH(booking_date) = MONTH(booking_date)
        AND YEAR(booking_date) = YEAR(booking_date) AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
        ...
        while($row=mysql_fetch_assoc($sql_hotel)){
            ...
            AND YEAR(created_at) = YEAR(created_at) AND financial_year_id='$financial_year_id' and customer_id='$customer_id'"));
            $sq_hotel_month_pre = mysql_fetch_assoc(mysql_query("SELECT sum(total_fee) as hotel_total
            FROM hotel_booking_master WHERE MONTH(created_at) = MONTH(created_at)
            AND YEAR(created_at) = YEAR(created_at) AND financial_year_id='$pre_financial_year_id' and customer_id='$customer_id'"));
