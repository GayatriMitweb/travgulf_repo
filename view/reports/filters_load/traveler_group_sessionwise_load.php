...
<?php
  ...
  if(isset($_SESSION['booker_id']))
  {
  	...
  	$query = "select id, traveler_group_id from tourwise_traveler_details where tour_id = '$tour_id' and tour_group_id = '$tour_group_id' and tour_group_status!='Cancel' and booker_id='$booker_id' ";
  }	
  else
  {
  	$query = "select id, traveler_group_id from tourwise_traveler_details where tour_id = '$tour_id' and tour_group_id = '$tour_group_id' and tour_group_status!='Cancel' ";
  }	
  ...
  echo "<option value=''> Select Traveler Group Name </option>";
