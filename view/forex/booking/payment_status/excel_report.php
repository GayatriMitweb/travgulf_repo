...
$row_count = 11;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('P'.$row_count, "Total Sale")
        ...
        while($row_booking = mysql_fetch_assoc($sq_booking)){
            ...
            $total_sale = $row_booking['net_total'] + $credit_card_charges;
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('P'.$row_count, number_format($total_sale,2))
            ->setCellValue('Q'.$row_count, number_format($paid_amount,2))
            ->setCellValue('R'.$row_count, number_format($bal,2))
