...
<div class="app_panel_content Filter-panel">
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
		    ...
		    <?php    get_forex_booking_dropdown($role, $branch_admin_id, $branch_status_r,$emp_id,$role_id)  ?>
		    </select>
		</div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
function customer_info_load()
{
	...
	$.ajax({
		...
		data:{ customer_id : customer_id , branch_status : branch_status_r },
...
function list_reflect()
{
	...
	var base_url = $('#base_url').val();
	var branch_status_r = $('#branch_status_r').val();
	$.post(base_url+'view/forex/booking/payment_status/list_reflect.php', { customer_id : customer_id, booking_id : booking_id,from_date:from_date,to_date:to_date, cust_type : cust_type, company_name : company_name,booker_id:booker_id,branch_id : branch_id, branch_status : branch_status_r   }, function(data){
...
list_reflect();
	...
	function excel_report()
	{
	    ...
	    var base_url = $('#base_url').val();
		var branch_status_r = $('#branch_status_r').val();
		window.location = base_url+'view/forex/booking/payment_status/excel_report.php?customer_id='+customer_id+'&booking_id='+booking_id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&booker_id='+booker_id+'&branch_id='+branch_id+'&branch_status='+branch_status_r;
	}
	...
	function company_name_reflect()
		{  
	        ...
	        var base_url = $('#base_url').val();
	        var branch_status_r = $('#branch_status_r').val();
		  	$.post(base_url+'view/forex/booking/booking/company_name_load.php', { cust_type : cust_type, branch_status : branch_status_r  }, function(data){
	...
	function dynamic_customer_load(cust_type, company_name)
	{
	  ...
	  var base_url = $('#base_url').val();
	  var branch_status_r = $('#branch_status_r').val();
	    $.get(base_url+'view/forex/booking/booking/get_customer_dropdown.php', { cust_type : cust_type , company_name : company_name, branch_status : branch_status_r }, function(data){
