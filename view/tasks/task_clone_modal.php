...
$sq_task = mysql_fetch_assoc(mysql_query("select * from tasks_master where task_id='$reference_task_id'"));
?>
<div class="modal fade" id="tasks_clone_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="row mg_bt_10">
          ...
          <div class="col-md-6">
            <select name="assign_to1" id="assign_to1">
              ...
              <?php
              $sq_employee = mysql_query("select * from emp_master");
