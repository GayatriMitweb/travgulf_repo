...
?>
    <!-- Filter-panel -->
      ...
      <div class="app_panel_content Filter-panel">
		<div class="row">		
			<div class="col-md-3">			
				<select name="passport_id_filter1" id="passport_id_filter1" style="width:100%" onchange="passport_payment_list_reflect()">
...
<script>
$('#passport_id_filter1').select2();
	function passport_payment_list_reflect()
	{
		var passport_id = $('#passport_id_filter1').val();

		$.post('bookings/passport/payment/passport_payment_list_reflect.php', { passport_id : passport_id }, function(data){
