...
$id = $_POST['id'];
$sq_payment = mysql_fetch_assoc(mysql_query("select * from visa_supplier_payment where id='$id'"));
      ...
      <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">                
                <select id="sup_id1" name="sup_id" style="width:100%" title="Visa Supplier" disabled>
                  <?php 
                  if($sq_payment['supplier_id']!='0'){
                  $supplier_id = $sq_payment['supplier_id'];
                  $sq_sup1 = mysql_fetch_assoc(mysql_query("select * from visa_vendor where vendor_id='$sq_payment[supplier_id]'"));
                  ?>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" id="payment_amount1" name="payment_amount" placeholder="Topup Amount" title="Topup Amount" value="<?= $sq_payment['payment_amount'] ?>" onchange="validate_balance(this.id);payment_amount_validate(this.id,'payment_mode','transaction_id','bank_name')">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                <input type="text" id="transaction_id1" name="transaction_id" onchange="validate_balance(this.id)" class="form-control" placeholder="Cheque No/ID" title="Cheque No/ID" <?= $disabled ?> value="<?= $sq_payment['transaction_id'] ?>">
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
$('#frm_update').validate({
  ...
  submitHandler:function(form){
    ...
    $.ajax({
      type:'post',
      url:base_url+'controller/visa_supplier/payment_update.php',
