		  		...
		  		<div class="profile_box">
                    ...
                    <table  class="table table-bordered no-marg">
                     ...
                     <tbody>
                       <?php 
                       $count = 0;
                       $sq_query = mysql_query("SELECT * FROM package_payment_master WHERE booking_id = '$booking_id' and amount!='0' and clearance_status!='Cancelled'");
                        ...
                        $bg='warning';
                          ...
                          $bg='success';
                           ...
                           <tr>
                              ...
                              <td><?php echo number_format($row_entry['amount']+$row_entry['credit_charges'],2); ?></td>
