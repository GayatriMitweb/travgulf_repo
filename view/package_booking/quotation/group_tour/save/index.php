      ...
      <div class="modal-body">
      	...
      	<section id="sec_ticket_save" name="frm_ticket_save">
			  ...
			  <ul class="nav nav-tabs text_left_sm_xs" role="tablist">
			    ...
			    <li role="presentation"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Select Package</a></li>
			    <li role="presentation"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Travel Information</a></li>
...
$('#txt_arrval1,#txt_dapart1, #train_arrival_date,#cruise_departure_date,#cruise_arrival_date,#train_departure_date').datetimepicker({ format:'d-m-Y H:i:s' });
