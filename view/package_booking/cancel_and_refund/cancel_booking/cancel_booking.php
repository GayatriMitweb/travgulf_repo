...
<div class="row text-center text_left_sm_xs mg_bt_10">	
    ...
    <!-- <label for="rd_package_report" class="app_dual_button mg_bt_10">
        <input type="radio" id="rd_package_report" name="rd_package" onchange="booking_content_reflect()">
        &nbsp;&nbsp;Report Summary
    </label> -->
</div>
...
function booking_content_reflect()
{
	...
	// if(id=="rd_package_report"){
	// 	$.post('report/refund_booking.php', {}, function(data){
	// 		$('#div_booking_content_reflect').html(data);
	// 	});
	// }
}
