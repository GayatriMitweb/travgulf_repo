...
?>
<select name="customer_id_filter" id="customer_id_filter" class="form-control" title="Select Customer" style="width:100%" onchange="train_ticket_id_dropdown_load(this.id,'train_ticket_id_filter')">
