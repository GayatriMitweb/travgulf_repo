...
while($row_train_ticket_payment = mysql_fetch_assoc($sq_train_ticket_payment)){
	...
	$temp_arr = array( "data" => array(
		...
		<button class="btn btn-info btn-sm" data-toggle="tooltip"  onclick="train_ticket_payment_update_modal('.$row_train_ticket_payment['payment_id'].')" title="Update Details"><i class="fa fa-pencil-square-o"></i></button>'
		), "bg" =>$bg );
