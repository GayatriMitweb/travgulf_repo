...
<div class="app_panel_content Filter-panel">
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<button class="btn btn-sm btn-info ico_right" onclick="train_member_report_list_reflect()">Proceed&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button>
		</div> 
	</div>
</div>	

<div id="div_train_ticket_report_list" class="main_block"></div>
...
<script>
	...
	function train_member_report_list_reflect()
	{
		...
		$.post('member_report/ticket_report_list_reflect.php', { customer_id : customer_id, train_ticket_id : train_ticket_id, from_date : from_date, to_date : to_date , cust_type : cust_type, company_name : company_name, branch_status : branch_status}, function(data){
			$('#div_train_ticket_report_list').html(data);
		});
	}
	function excel_report()
		{
			...
			var company_name = $('#company_filter').val();
			var branch_status = $('#branch_status').val();
			window.location = 'member_report/excel_report.php?customer_id='+customer_id+'&train_ticket_id='+train_ticket_id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&branch_status='+branch_status;
		}
