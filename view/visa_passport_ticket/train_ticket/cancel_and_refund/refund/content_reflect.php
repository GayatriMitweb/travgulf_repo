...
$sq_pay = mysql_fetch_assoc(mysql_query("select sum(refund_amount) as sum from train_ticket_refund_master where train_ticket_id='$sq_train_ticket_info[train_ticket_id]'"));
$sq_ref_pen_total = mysql_fetch_assoc(mysql_query("select sum(refund_amount) as sum from train_ticket_refund_master where train_ticket_id='$sq_train_ticket_info[train_ticket_id]' and clearance_status='Pending'"));
$sq_ref_can_total = mysql_fetch_assoc(mysql_query("select sum(refund_amount) as sum from train_ticket_refund_master where train_ticket_id='$sq_train_ticket_info[train_ticket_id]' and clearance_status='Cancelled'"));
