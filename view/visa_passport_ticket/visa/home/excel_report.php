...
while($row_visa = mysql_fetch_assoc($sq_visa)){
    ...
    //Get Total visa cost
    $sq_visa_total_cost=mysql_fetch_array(mysql_query("select * from visa_master where visa_id='$row_visa[visa_id]'"));
...
header('Content-Disposition: attachment;filename="VisaBooking('.date('d-m-Y H:i:s').').xls"');
