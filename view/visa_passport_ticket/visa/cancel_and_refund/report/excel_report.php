...
if($visa_id != ''){
  $sq_entry_year = mysql_fetch_assoc(mysql_query("select * from visa_master where visa_id='$visa_id'"));
...
header('Content-Disposition: attachment;filename="Visa Booking Refund('.date('d-m-Y H:i:s').').xls"');
