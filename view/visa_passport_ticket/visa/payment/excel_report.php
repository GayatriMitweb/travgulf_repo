...
while($row_visa_payment = mysql_fetch_assoc($sq_visa_payment)){
	...
	$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('C'.$row_count, get_visa_booking_id($row_visa_payment['visa_id'],$year))
...
header('Content-Disposition: attachment;filename="VisaPayment('.date('d-m-Y H:i:s').').xls"');
