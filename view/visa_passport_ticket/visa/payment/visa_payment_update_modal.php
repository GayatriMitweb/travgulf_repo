...
$sq_visa = mysql_fetch_assoc(mysql_query("select * from visa_master where visa_id='$sq_payment_info[visa_id]'"));
         ...
         <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
            <select name="visa_id1" id="visa_id1" style="width:100%" title="Booking ID" disabled>              
              ...
              <?php
              $sq_visa = mysql_query("select * from visa_master where customer_id='$sq_visa[customer_id]'");
