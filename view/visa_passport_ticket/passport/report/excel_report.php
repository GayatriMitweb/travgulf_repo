...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Passport Report')
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('G'.$row_count, "Received Documents");
...
$sq_passport = mysql_query($query);
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('F'.$row_count, date('d-m-Y', strtotime($row_entry['birth_date'])))
            ->setCellValue('G'.$row_count, $row_entry['received_documents']);
...
header('Content-Disposition: attachment;filename="PassportReport('.date('d-m-Y H:i:s').').xls"');
