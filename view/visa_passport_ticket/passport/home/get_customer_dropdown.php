...
?>
<select name="customer_id_filter" id="customer_id_filter" onchange="passport_id_dropdown_load(this.id,'passport_id_filter')" class="form-control" title="Select Customer" style="width:100%">
