...
<div class="modal fade profile_box_modal" id="flight_display_modal" role="dialog" aria-labelledby="myModalLabel">
		  		...
		  		<div class="profile_box">
                    ...
                    <table  class="table table-bordered no-marg">
                     ...
                     <tbody>
                       <?php 
                       $count = 0;
                       $sq_query = mysql_query("SELECT * FROM vendor_estimate WHERE estimate_type LIKE 'Ticket Booking' AND estimate_type_id = '$ticket_id'");
