...
<script>
	...
	function ticket_report_list_reflect()
	{
		...
		$.post('member_report/ticket_report_list_reflect.php', { customer_id : customer_id, ticket_id : ticket_id , cust_type : cust_type, company_name : company_name, branch_status : branch_status }, function(data){
	...
	function excel_report()
	{
		...
		var company_name = $('#company_filter').val();
		var branch_status = $('#branch_status').val();
		window.location = 'member_report/excel_report.php?customer_id='+customer_id+'&ticket_id='+ticket_id+'&cust_type='+cust_type+'&company_name='+company_name+'&branch_status='+branch_status;
	}
</script>
