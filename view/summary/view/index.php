...
<div class="modal fade profile_box_modal" id="package_display_modal" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
	...
	<!--  Train   -->
	<?php $sq_train_count = mysql_num_rows(mysql_query("select * from package_train_master where booking_id='$booking_id'")); 
	if($sq_train_count != '0' ){?>
	<div class="row">    
		...
		<?php } ?>
		<!--  Flight   -->
	<?php $sq_plane_count = mysql_num_rows(mysql_query("select * from package_plane_master where booking_id='$booking_id'")); 
	if($sq_plane_count != '0' ){?>
	<div class="row">    
		  	<div class="col-xs-12 mg_bt_20">
		  		<div class="profile_box">
