...
function bank_receipt(){
	var payment_mode = $('#payment_mode_filter').val();
	$.post('payment/bank_receipt_generate.php',{payment_mode : payment_mode}, function(data){
	...
	function cash_bank_receipt_generate()
{
	...
	var url = base_url+"view/bank_receipts/hotel_booking_payment/cash_bank_receipt.php?payment_id_arr="+payment_id_arr+'&bank_name_reciept='+bank_name_reciept;
...
function cheque_bank_receipt_generate()
{
	...
	var url = base_url+"view/bank_receipts/hotel_booking_payment/cheque_bank_receipt.php?payment_id_arr="+payment_id_arr+'&branch_name_arr='+branch_name_arr+'&bank_name_reciept='+bank_name_reciept;
	window.open(url, '_blank');
}
function whatsapp_send_r(booking_id, payment_amount, base_url){
	$.post(base_url+'controller/hotel/payment/whatsapp_send.php',{booking_id:booking_id, payment_amount:payment_amount}, function(data){
		window.open(data);
	});
}
</script>
