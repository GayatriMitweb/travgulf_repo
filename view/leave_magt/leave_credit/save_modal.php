         ...
         <div class="row mg_bt_10">
              <div class="col-md-4"><label for="emp_id">User Name</label></div>
                ...
                <select name="emp_id" id="emp_id1"  class="form-control" style="width: 100%;" title="User Name" title="User Name">
                  ...
                  <?php
                    $sq_user = mysql_query("select emp_id, first_name, last_name from emp_master where role_id!=1 and active_flag='Active' order by first_name");
         
                  while($row_user = mysql_fetch_assoc($sq_user)){
