...
$sq_rules = mysql_fetch_assoc(mysql_query("select * from other_master_rules where rule_id='$rule_id'"));
          ...
          <div class="row mg_bt_20">
            <div class="col-md-3 col-md-offset-4">
                <select name="rule_for1" id="rule_for1" data-toggle="tooltip" class="form-control" title="Rule For" required>
                  <?php 
                  $sq_other = mysql_fetch_assoc(mysql_query("select * from other_charges_master where entry_id='$sq_rules[rule_for]'")); ?>
