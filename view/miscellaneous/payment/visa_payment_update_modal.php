...
$sq_visa = mysql_fetch_assoc(mysql_query("select * from  miscellaneous_master where misc_id='$sq_payment_info[misc_id]'"));
...
<div class="modal fade" id="visa_payment_update_modal" role="dialog" aria-labelledby="myModalLabel">
         ...
         <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
            <select name="visa_id1" id="visa_id1" style="width:100%" title="Booking ID" disabled>              
              ...
              <?php
              $sq_visa = mysql_query("select * from miscellaneous_master where customer_id='$sq_visa[customer_id]'");
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
            <input type="text" id="transaction_id1" name="transaction_id1" onchange="validate_specialChar(this.id)" class="form-control" placeholder="Cheque No/ID" title="Cheque No/ID" value="<?= $sq_payment_info['transaction_id'] ?>" <?= $enable ?>>
          </div>
