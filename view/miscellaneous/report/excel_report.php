        ...
        {   
            ...
            while($row_entry = mysql_fetch_assoc($sq_entry))
            {
                ...
                ->setCellValue('H'.$row_count, $row_entry['passport_id'])
                 ->setCellValue('I'.$row_count, $row_entry['issue_date'])
                ->setCellValue('J'.$row_count, $row_entry['expiry_date']);
...
header('Content-Disposition: attachment;filename="MiscellaneousReport('.date('d-m-Y H:i:s').').xls"');
