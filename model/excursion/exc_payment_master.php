...
public function finance_save($payment_id, $branch_admin_id)
{
	...
	if($payment_mode == 'Credit Card'){
		...
		$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date, $credit_charges, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1);
		...
		$payment_amount = $credit_charges;
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = 224;
		$payment_side = "Credit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
$finance_charges = number_format($finance_charges,2);
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = 231;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $company_gl;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date, $payment_amount1, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $pay_gl;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
...
public function finance_update($sq_payment_info, $clearance_status1)
{
	...
	if($payment_amount1 != $payment_old_value){
		...
		if($payment_mode == 'Credit Card'){
			...
			$payment_amount = $credit_charges_old;
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date1, $credit_charges_old, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1,$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 224;
			$payment_side = "Debit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
$finance_charges = number_format($finance_charges,2);
			...
			$payment_amount = $finance_charges;
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_exc_booking_payment_id($exc_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_exc_booking_id($exc_id,$yr1),$bank_id,$transaction_id1,$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 231;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
public function payment_email_notification_send($exc_id, $payment_amount, $payment_mode, $payment_date)
{
   ...
   $sq_customer_info = mysql_fetch_assoc(mysql_query("select email_id,first_name from customer_master where customer_id='$sq_exc_info[customer_id]'"));
   ...
   $sq_total_amount = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from exc_payment_master where exc_id='$exc_id' and clearance_status!='Cancelled'"));
   ...
   global $model;
   $model->generic_payment_mail('54',$payment_amount, $payment_mode, $total_amount, $paid_amount, $payment_date, $due_date,$email_id, $subject,$sq_customer_info['first_name']);
}
...
{
 global $secret_key,$encrypt_decrypt;
	$sq_payment_info = mysql_fetch_assoc(mysql_query("select * from exc_payment_master where payment_id='$payment_id' and clearance_status!='Cancelled'"));
	...
	global $model;
		$model->generic_payment_mail('64',$payment_amount, $payment_mode, $total_amount, $paid_amount, $payment_date, $due_date,$email_id,$subject, $update_payment,$sq_customer_info['first_name']);
...
public function payment_sms_notification_send($exc_id, $payment_amount, $payment_mode)
{
	...
	$message = "Dear ".$sq_customer_info['first_name']." ".$sq_customer_info['last_name'].", Acknowledge your payment of ".$payment_amount." ".$currency_code.", ".$payment_mode." which we received for Excursion booking installment.";
    global $model;
...
public function whatsapp_send(){
   ...
   $sq_ticket_info = mysql_fetch_assoc(mysql_query("select * from excursion_master where exc_id=".$_POST['booking_id']));

   $total_amount = $sq_ticket_info['exc_total_cost'];
   $sq_pay = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from exc_payment_master where clearance_status!='Cancelled' and exc_id=".$_POST['booking_id']));
