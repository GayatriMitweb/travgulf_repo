...
{	
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_images"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_images WHERE quotation_id='$quotation_id'");
