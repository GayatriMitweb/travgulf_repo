...
public function bank_cash_book_save($refund_id)
{
	...
	$transaction_id = $transaction_id;
	$bank_id = $bank_id;
	$particular = get_refund_paid_particular(get_car_rental_booking_id($booking_id,$yr1), $refund_date, $refund_amount, $refund_mode, get_car_rental_booking_refund_id($refund_id,$yr1),$bank_id,$transaction_id);
