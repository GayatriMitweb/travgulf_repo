...
public function finance_save($payment_id,$branch_admin_id)
{
	...
	if($payment_mode == 'Credit Card'){
		...
		$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date, $credit_charges, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1);
		...
		$payment_amount = $credit_charges;
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date1, $credit_charges, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = 224;
		$payment_side = "Credit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = 231;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date, $credit_company_amount, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $company_gl;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
		...
		$payment_date = $payment_date;
		$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date, $payment_amount1, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1);
		$ledger_particular = get_ledger_particular('By','Cash/Bank');
		$gl_id = $pay_gl;
		$payment_side = "Debit";
		$clearance_status = ($payment_mode=="Cheque" || $payment_mode == 'Credit Card') ? "Pending" : "";
...
public function finance_update($sq_payment_info, $clearance_status1)
{
	...
	if($payment_amount1 != $payment_old_value){
		...
		if($payment_mode == 'Credit Card'){
			...
			$payment_amount = $credit_charges_old;
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date1, $credit_charges_old, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1,$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 224;
			$payment_side = "Debit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
$finance_charges = number_format($finance_charges,2);
			...
			$payment_amount = $finance_charges;
			$payment_date = $payment_date;
			$payment_particular = get_sales_paid_particular(get_visa_booking_payment_id($visa_id,$yr1), $payment_date1, $finance_charges, $customer_id, $payment_mode, get_visa_booking_id($visa_id,$yr1),$bank_id,$transaction_id1,$bank_id,$transaction_id1);
			$ledger_particular = get_ledger_particular('By','Cash/Bank');
			$gl_id = 231;
			$payment_side = "Credit";
			$clearance_status = ($payment_mode=="Cheque"||$payment_mode=="Credit Card") ? "Pending" : "";
...
public function bank_cash_book_update($clearance_status)
{
	...
	$sq_visa_info = mysql_fetch_assoc(mysql_query("select created_at,customer_id from visa_master where visa_id='$visa_id'"));
	$customer_id = $sq_visa_info['customer_id']; 
...
public function payment_sms_notification_send($visa_id, $payment_amount, $payment_mode)
{
	...
	$message = "Dear ".$sq_customer_info['first_name']." ".$sq_customer_info['last_name']." Acknowledge your payment of ".$payment_amount." ".$currency_code.", which we received for Visa services installment.";
    global $model;
