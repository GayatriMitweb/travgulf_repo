...
$sq_hotel = mysql_fetch_assoc(mysql_query("select * from bus_booking_master where booking_id='$booking_id'"));
...
$net_amount1 = 0;
$net_amount1 =  ($basic_cost1 + $service_charge  + $sq_hotel['markup'] + $markupservice_tax_amount +$service_tax_amount)+$roundoff;
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">CURRENT DUE </span><span class="font_5 float_r"><?= $currency_code." ".number_format($balance_amount-$charge,2) ?></span></p></div> 
      </div>
    </div>
  </div>
</section>
